...
#### `is_local_max(input: any[] | Mat | Tensor, dim: '0' | '1') : Mat | Tensor`
...
**returns** - a matrix or tensor with 1 denoting the local max value was there and 0 denoting that it wasn't.
